...
(function (factory) {
  ...
  var VideoDialog = function (context) {
    ...
    this.createVideoNode = function (url) {
      ...
      //http://v.qq.com/iframe/player.html?vid=h0189ocflua&tiny=0&auto=0
      ...
      } else if (qqMatch && qqMatch.length) {
        $video = $('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
            .attr('frameborder', 0)
            .attr('height', '498')
            .attr('width', '640')
            .attr('src', '//v.qq.com/iframe/player.html?vid=w0019b5vvqw&tiny=0&auto=0');
